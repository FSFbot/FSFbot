...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=3CB371&size=35&center=true&vCenter=true&width=1000&lines=Olá,+meu+nome+é+Felipe+Freitas;Especialista+em+Análise+de+Dados+e+Desenvolvimento+Web;Focado+em+Python,+Django+e+Cloud+Computing;Bem-vindo+ao+meu+perfil+do+GitHub!)](https://git.io/typing-svg)
...
![Gráfico de Contribuições](https://activity-graph.herokuapp.com/graph?username=FSFbot&bg_color=0d1117&color=3CB371&line=3CB371&point=FFFFFF&area=true&hide_border=true)
